...
const sizes = {
  sm: "lg:px-[5px] xl:px-[6px] 2xl:px-[7px] px-[8px] 3xl:px-[9px] 3xl:py-[10px] lg:py-[6px] xl:py-[7px] 2xl:py-[8px] py-[9px]",
  md: "lg:p-[11px] xl:p-[14px] 2xl:p-[16px] p-[17px] 3xl:p-[19px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#19d1b2",
              "&:hover": { backgroundColor: "#19d1b2", color: "#ffffff" },
            }),
